...
const App = () => {
  ...
  const appID = 544640751;
  const serverSecret = "f902fda1868e1c2b48d1ecf8e4f251f7";
  ...
  return (
    <div className='w-full h-screen bg-gradient-to-b from-[#1a2229] to-black flex items-center justify-center'>
      <div className='w-[500px] h-[400px] bg-[#0d1014] border-2 border-[#313030] 
      flex flex-col items-center justify-center gap-[20px] '>
        ...
        <button className='w-[200px] cursor-pointer h-[50px] bg-white text-black text-[20px] rounded-2xl' onClick={()=>invite(ZegoUIKitPrebuilt.InvitationTypeVoiceCall)}>Voice Call</button>
        <button className='w-[200px] cursor-pointer h-[50px] bg-white text-black text-[20px] rounded-2xl' onClick={()=>invite(ZegoUIKitPrebuilt.InvitationTypeVideoCall)}>Video Call</button>
      </div>
    </div>
  )
}
