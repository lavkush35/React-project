...
const Player = () => {
  ...
  return (
    ...
    rounded-t-[30px] shadow-lg flex pt-[10px] md:items-center md:p-[5px] '>
        ...
        {
            !playingSong?
            <div className='w-[50px] h-[50px] rounded-full bg-black text-white flex justify-center items-center hover:bg-gray-600 transition-all
            ...
            hover-bg-gray-600 transition-all cursor-pointer ' onClick={() => pauseSong()} > <MdOutlinePause className='w-[20px] h-[20px]' /></div>
        }
        </div>
    </div>
  )
